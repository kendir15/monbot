...
exports.run = (client, message, params) => {
 ...
 .addField("**》 Yapımcım 《**", `<@720562744629264427>`)
  .addField("Botu Kullanan Sunucu Sayısı:",`${client.guilds.size.toLocaleString()}`, true)
  .addField("Botu Kullanan Toplam Kullanıcı Sayısı:", `${client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString()}`, true)
