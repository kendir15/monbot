...
exports.run = async (bot, msg, args) => {
    ...
    if (kurulus > 1296000000) kontrol = 'Güvenilir'
      ...
      userinfo.status = user.presence.status.toString()
        .replace("dnd", `<:d_:744093778809192548>  Rahatsız Etmeyin`)
        .replace("online", `<:cevrimici:744095979740987412>  Çevrimiçi`)
        .replace("idle", `<:dd:744095415711825942>  Boşta`)
        .replace("offline", `<:gizli:744096403948830830>  Çevrimdışı`)  
